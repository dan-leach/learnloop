<?php
    ...
    if ($result = $link->query("SELECT sName, sDate, fName, sCert FROM tbl_sessions WHERE sIdent = '$sIdent'")) {
        ...
        echo "Error retrieving certificate. The server returned the following error message: " . mysqli_error($link);
    }
