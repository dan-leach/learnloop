console.log ("feedback-app-v5.js running...")
...
var app = new Vue({
    ...
    methods: {
      ...
      createSession: function(){
        ...
        this.api('insertSession', null, null, this.escapeAmpersand(JSON.stringify(this.session))).then(
          function(res) {
            ...
            let tempLink = 'https://learnloop.co.uk/feedback/?' + app.session.id
            ...
            app.invite.view = 'https://learnloop.co.uk/feedback/?view=' + app.session.id
            ...
            window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/?sessionCreated")
          },
          function(error) {
      ...
      loadPinUpdateDetails: function(){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/?edit="+this.session.id)
      ...
      submitUpdateDetails: function(){
        ...
        this.api('updateDetails', this.session.id, this.session.pin, this.escapeAmpersand(JSON.stringify(this.session))).then(
          function(res) {
            ...
            app.showComponent('welcome')
            window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/")
            Swal.fire({
              icon: 'success',
              text: res
            })
      ...
      loadGiveFeedback: function(){
        ...
        window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/?"+this.session.id)
      ...
      loadPinViewFeedback: function(){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/?view="+this.session.id)
      ...
      loadPinViewAttendance: function(){
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/?attendance="+this.session.id)
      ...
      showComponent: function(comp){
        ...
        if (comp == "createSession") window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/?createSession")
        if (comp == "createSessionSeries") window.history.replaceState("https://learnloop.co.uk", "LearnLoop", "/feedback/?createSessionSeries")
      },
